"""
This file initialises an experiment. It instantiates instruments and binds them
to a station.
A folder for data is created. Specify folder structure and folder names in
qc.init('path/to/experiments', 'experiment_name', station)
"""
...
if __name__ == '__main__':
    ...
    keysight = Keysight_33500B('keysight',
                               'TCPIP0::A-33522B-12403::inst0::INSTR')
