...
##import modules.pulsebuilding.ripasso as bb
...
#
##%run -i modules/Majorana/Experiment_init
##runfile('A:/qcodes_experiments/start spyder.py', wdir='A:/qcodes_experiments')
#from modules.Majorana.Experiment_init import *
#
#
...
#qdac_chans = []
#for i in range(1,49):
#    chan = 'ch{:02d}_v'.format(i)
#    qdac_chans.append(getattr(qdac, chan))
#    
#qc.Monitor(*qdac_chans, zi.oscillator1_freq, zi.oscillator2_freq,
#           zi.scope_channel1_input, zi.scope_channel2_input, keithleybot_a.volt)
#
